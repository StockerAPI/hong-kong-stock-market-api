...
Kun Data provides real-time market data for Hong Kong through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Hong Kong market coverage with support for HSI, HKEX.

## API Capabilities

- Real-time WebSocket market data for Hong Kong
...
This repository is designed to make Hong Kong market API coverage easier to discover and evaluate.

## Links

- Website: https://kun.pro/markets/hong-kong-stock-market-api
